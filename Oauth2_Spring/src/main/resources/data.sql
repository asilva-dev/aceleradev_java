...
-- insert into submission (created_at, suite, user_id, challenge_id)
-- values (now(), 88, 6001, 1003);

-- insert into submission (created_at, suite, user_id, challenge_id)
-- values (now(), 97, 6001, 1003);

insert into submission (created_at, score, user_id, challenge_id)
values (now(), 67, 6002, 1003);

-- insert into submission (created_at, suite, user_id, challenge_id)
-- values (now(), 78, 6002, 1003);
...
-- insert into submission (created_at, suite, user_id, challenge_id)
-- values (now(), 78, 6004, 1002);

-- insert into submission (created_at, suite, user_id, challenge_id)
-- values (now(), 98, 6004, 1002);
